...
export default class HighchartsReactNative extends React.PureComponent {
  ...
  setHcAssets = async (useCDN) => {
    try {
      ...
      this.addScript('highcharts', null, false);
      this.addScript('highcharts-more', null, false);
      this.addScript('highcharts-3d', null, false);
      //   for (const mod of this.state.modules) {
      //     await this.addScript(mod, true, false);
      //   }
