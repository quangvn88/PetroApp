...
const SearchFilter = ({ placeholder, fromBukrs, handleKunnrs }) => {
    const [bukrsSelected, updateSelected] = React.useState([...fromBukrs.fromBukrs]);
    ...
    const toggleModal = () => {
        handleKunnrs({ ...fromBukrs, isVisible: false });
    };
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1, marginTop: 10 }}>
                {bukrsSelected.length !== 0 ?
                    <FlatList
                        initialNumToRender={bukrsSelected.length - 1}
                        data={bukrsSelected}
            ...
            <View style={styles.bottom}>
                <TouchableOpacity
                    ...
                    onPress={() => {
                        // set fromBukrs
                        handleKunnrs({
                            fromBukrs: [...bukrsSelected],
                            isVisible: false,
                            bukrsSelected: [...bukrsSelected]
                        })
                        // toggleModal();
                    }}
                >
